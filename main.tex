...
\cvitem{}{Aiming to become machine intelligence leader; data scientist.}
\section{Nationality}
...
\cvitem{2018}{Math Instructor, All-Girls Math League funded by the Dragon Kim Foundation.}
\section{Computer skills}
\cvitem{Advanced}{Python, PyStan, Pandas}
\cvitem{}{Arduino C, used Nanos, Unos, 101s,
  Dues, several specific sensor libraries, developed PID controller.}
\cvitem{Intermediate}{Stan}
\cvitem{}{Java, Object oriented functionality}
\cvitem{}{Latex, Bibtex, Overleaf}
\cvitem{Beginner}{Git, C, Matlab, Keras, Tensorflow}
